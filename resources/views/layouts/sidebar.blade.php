<aside id="logo-sidebar"
    ...
    aria-label="Sidebar" :class="sidebar == true ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <x-sidebar-link :href="route('error_trackings.index')" :active="request()->routeIs('error_trackings.index')">
                    ...
                    <span class="ms-3">Daily Error List</span>
                </x-sidebar-link>
            </li>
            <!-- Show Project Name only for admin -->
            <li>
            ...
            <!-- Show Developer Name only for admin -->
            @if (auth()->user()->role == 'admin')
                <li>
                    <x-sidebar-link :href="route('users.index')" :active="request()->routeIs('users.index')">
                        ...
                        <span class="ms-3">Developer Name</span>
                    </x-sidebar-link>
                </li>
            @endif
        </ul>
